...
public class AppPercentController {
	...
	public ArrayList<AppPercent> getAppPercent() {
		...
		return repository.getAppPercent(/*dateformat.format(Calendar.getInstance().getTime())*/"2019-02-18");
	}
	
	@RequestMapping("/AppPercentApp/{appName}")
	public ArrayList<AppPercentApp> getAppPercentApp(@PathVariable String appName) {
		//SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
		return repository.getAppPercentApp(appName, /*dateformat.format(Calendar.getInstance().getTime())*/"2019-02-18");
	}
	...
	public ArrayList<AppPercentSeverity> getAppPercentSeverity(@PathVariable String severityName) {
		//SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
		return repository.getAppPercentSeverity(severityName, /*dateformat.format(Calendar.getInstance().getTime())*/"2019-02-18");
	}
